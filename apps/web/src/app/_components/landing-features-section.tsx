...
export default function LandingFeaturesSection() {
  return (
    <section className="mx-auto flex max-w-7xl flex-col gap-8 px-6 py-10 sm:px-8 sm:py-16 lg:px-16 lg:py-20">
      <h2 className="mx-auto max-w-full text-center font-bold text-[1.375rem] text-foreground leading-[1.4] tracking-normal [overflow-wrap:anywhere] sm:text-4xl">
        {LANDING_FEATURES_HEADING}
      </h2>
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col gap-2">
                <h3 className="font-semibold text-[1.0625rem] text-foreground tracking-normal [overflow-wrap:anywhere] sm:text-xl">
                  {feature.title}
                </h3>
                <p className="text-muted-foreground text-sm leading-[1.7] [overflow-wrap:anywhere]">
                  {feature.description}
                </p>
              </div>
            </article>
